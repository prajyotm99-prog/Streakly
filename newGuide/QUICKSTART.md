...
```bash
# Android native
cp android/*.java android/app/src/main/java/com/streakly/app/
...
## If It Doesn't Work
1. Check: `adb shell appops get com.streakly.app SCHEDULE_EXACT_ALARM` → should be `allow`
2. Check: Settings → Apps → Streakly → Battery → Unrestricted
